...
// GetASCIIStringLitral is a string function that will return ascii.
...
// IterateOverASCIIStringLiteral will iterate over this for loop
...
// GreetingASCII funksjonen skal generere en utskrift fra en sekvens av bytes,
